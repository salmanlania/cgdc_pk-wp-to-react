            ...
            <div className="banner font-outfit items-center justify-center md:justify-start">
                <Carousel effect="fade" autoplay>
                    <div className="bannerOne relative">
                        <div className="banner-text md:block w-7/12 lg:w-5/12 absolute top-1/2 transform  translate-600-1000 -translate-y-1/2  lg:static lg:top-auto lg:transform-none">
                    ...
                    <div className="bannerTwo relative">
                        <div className="banner-text md:block w-7/12 lg:w-6/12 absolute top-1/2 transform  translate-600-1000 -translate-y-1/2  lg:static lg:top-auto lg:transform-none">
